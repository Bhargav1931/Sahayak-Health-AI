...
### AI Agents with Google ADK | 4-Week Capstone
...
### Week 1 - Learn ADK Through Small Examples

Learners already know GenAI basics. Week 1 moves them from prompts to systems:
...
### Week 2 - Understand The Health Problem And Build The Baseline
...
### Week 4 - Evaluate, Calibrate, And Present
...
- **Calibrate the severity rubric on the train split**: the v1 rubric escalates
  ...
  condition archetypes and A/B it on a train sample. This is the core Week 4
