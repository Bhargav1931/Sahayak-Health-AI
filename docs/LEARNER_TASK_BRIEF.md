...
| Week | Marks | Submit / complete |
|---|---:|---|
| Week 1 | 9 | `learner/week1_adk_intro.ipynb` concept answers |
| Week 2 | 21 | `learner/week2_starter.ipynb` and the Week 2 functions in `learner/sahayak_starter.py` |
| Week 3 | 29 | `learner/week3_starter.ipynb` with your ADK agent instructions and pipeline assembly |
| Week 4 | 41 | `learner/week4_starter.ipynb` (evaluation, safety evaluator, failure analysis, improvement log) **plus `final_report.pdf`|
| **Total** | **100** | |

Your six graded deliverables: the **four notebooks**,
**`learner/sahayak_starter.py`**, and a **`final_report.pdf`** (written
in Week 4 — its required sections and marks are listed in the Week 4 notebook's
final-submission checkpoint). Files in `src/` are provided support modules
(demo, evaluation, tools) — you do not submit them.

## Week 1 - Learn ADK Basics
...
## Week 2 - Dataset, EDA, And Policy Baseline
...
## Week 4 - Evaluate, Diagnose, Improve
